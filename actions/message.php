                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="border-collapse:collapse;border-spacing:0px">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center" style="padding:25px;Margin:0">
                                                                    <h1 style="Margin:0;line-height:36px;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;font-size:36px;font-style:normal;font-weight:bold;color:#ffffff">12345</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
